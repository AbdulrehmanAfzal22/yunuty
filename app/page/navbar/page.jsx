      ...
      <div className="navbar-container">
        ...
        <ul className={`nav-links ${isMenuOpen ? "active" : ""}`}>
          ...
          <li className="mobile-btn-wrapper">
            <Link href="/contactus/contact" className="get-started-btn mobile" onClick={closeMenu}>
              Get Started
            </Link>
          </li>
        </ul>
        ...
        <Link href="/contactus/contact" className="get-started-btn desktop">Get Started</Link>
      </div>
